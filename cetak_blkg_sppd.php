  ...
  <tbody>';
   ...
   echo '<tr style="vertical-align: text-top;">
      ...
      echo '<tr style="vertical-align: text-top;">
          ...
          if($data['nama_guru'] == 'Wardoyo, S.Pd., M.Pd'){
            echo '<b>Kristiyono, S.Pd</b> <br>&nbsp&nbsp&nbsp&nbspNIP. 19680221 199802 1 002';
          } else {
   ...
   echo '<tr style="vertical-align: text-top;">
          ...
          if($data['nama_guru'] == 'Wardoyo, S.Pd., M.Pd'){
            echo '<b>Kristiyono, S.Pd</b> <br>NIP. 19680221 199802 1 002';
          } else {
