...
<html>
  <head>
    ...
    ?>
    <title>Surat Rekomendasi Ranking - <?php echo $data['nama_lengkap'];?> - <?php echo $data['kelas'];?></title>
<style>
    @media print
{    
    .no-print, .no-print *
...
<hr width="750" style="height:4px;border-width:2;color:black;background-color:black">	';
   ...
   echo '<tr>
    <td colspan="4" style="font-size:17px;"><div align="center">
  ...
  <table width="700" style="border: 0px solid black; border-collapse: collapse; margin-left: auto; margin-right: auto; font-size:17px;">
    <tbody>';
...
echo '<tr>
  ...
  <table width="700" style="border: 0px solid black; border-collapse: collapse; margin-left: auto; margin-right: auto;">
    ...
    <br><p style="line-height: 1.8;">'.$data['deskripsi'].'</p>
    </div></td>
  </tr>
  </tbody>
  </table>';
  ...
  echo '
  <table width="600" style="border: 1px solid black; border-collapse: collapse; margin-left: auto; margin-right: auto; margin-top: 15px;">
  ...
  <tbody>
    <tr style="border: 1px solid black">
      ...
      <td style="border: 1px solid black">&nbsp Kelas X Semester 1</td>
      <td>&nbsp Peringkat '.$data['rank_smt1'].' dari '.$data['jumlah_smt1'].' siswa di kelas</td>
    </tr>
    <tr style="border: 1px solid black">
      <td align="center" style="border: 1px solid black">2</td>
      <td style="border: 1px solid black">&nbsp Kelas X Semester 2</td>
      <td>&nbsp Peringkat '.$data['rank_smt2'].' dari '.$data['jumlah_smt2'].' siswa di kelas</td>
    </tr>
    <tr style="border: 1px solid black">
      <td align="center" style="border: 1px solid black">3</td>
      <td style="border: 1px solid black">&nbsp Kelas XI Semester 1</td>
      <td>&nbsp Peringkat '.$data['rank_smt3'].' dari '.$data['jumlah_smt3'].' siswa di kelas</td>
    </tr>
    <tr style="border: 1px solid black">
      <td align="center" style="border: 1px solid black">4</td>
      <td style="border: 1px solid black">&nbsp Kelas XI Semester 2</td>
      <td>&nbsp Peringkat '.$data['rank_smt4'].' dari '.$data['jumlah_smt4'].' siswa di kelas</td>
    </tr>
    <tr style="border: 1px solid black">
      <td align="center" style="border: 1px solid black">5</td>
      <td style="border: 1px solid black">&nbsp Kelas XII Semester 1</td>
      <td>&nbsp Peringkat '.$data['rank_smt5'].' dari '.$data['jumlah_smt5'].' siswa di kelas</td>
    </tr>
    <tr style="border: 1px solid black">
      <td align="center" style="border: 1px solid black">6</td>
      <td style="border: 1px solid black">&nbsp Kelas XII Semester 2</td>
      <td>&nbsp Peringkat '.$data['rank_smt6'].' dari '.$data['jumlah_smt6'].' siswa di kelas</td>
    </tr>
  </tbody>
    </table>
    ';
