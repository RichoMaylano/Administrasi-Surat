...
$title = "Perhotelan Page | Aplikasi Persuratan | Versi 2.1.2";
include 'header.php';
?>

<?php $pd = mysqli_query($db_conn, "SELECT COUNT(nisn) AS 'count' FROM data_siswa WHERE jurusan='Perhotelan' ");
$query_siswa = mysqli_fetch_array($pd);
$perhotelan = $query_siswa['count'];
?>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Kompetensi Keahlian Perhotelan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Kompetensi Keahlian</li>
              <li class="breadcrumb-item active">Perhotelan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-sm-8">
                <div class="card">
                    <div class="card-header bg-secondary"><i class="fas fa-users"></i>&nbsp Tabel Peserta Didik Kompetensi Keahlian Perhotelan</div>
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                    $qsiswa = mysqli_query($db_conn,"SELECT * FROM data_siswa WHERE jurusan='Perhotelan' ORDER BY nama_lengkap ASC");
                                    $no = 1;
                                ...
                                <td>
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-divider"></div>
                                            <a href="#" class="dropdown-item bg-secondary"><i class="fas fa-trash-alt mr-2"></i> Hapus Siswa</a>
                                            </div>
                                        </li> 
                                    </ul>
                                </td>
            ...
            <div class="col-sm-4 mb-4">
                <div class="card">
                    <div class="card-header bg-secondary"><i class="fas fa-info"></i>&nbsp Tentang Perhotelan</div>
                    <div class="card-body">
                        <div class="text-center">
                        <img src="../../assets/images/perhotelan.png" width="50px" alt="" class="mt-2 mb-4">
                        </div>

                        <h5 class="mt-2 mb-2"><strong>SEJARAH PERHOTELAN</strong></h5>
                        <p>Konsentrasi Keahlian Perhotelan merupakan salah satu jurusan di SMK Negeri 7 Surakarta. Konsentrasi keahlian Perhotelan ini berdiri pada tahun 2008. Tujuan didirikan Jurusan Konsentrasi Keahlian Perhotelan tersebut adalah mengingat perkembangan perhotelan dan pariwasata yang begitu pesat, dengan membuka jurusan Konsentrasi Keahlian Perhotelan tersebut diharapkan lulusan SMK Negeri 7 Surakarta akan mampu mengisi lowongan pekerjaan di industri perhotelan khususnya di wilayah Kota Surakarta dan sekitarnya. Memiliki Laboratorium yang Bernama Edotel yang di Resmikan pada tanggal 31 Oktober 2009 Oleh Bapak Ir. Joko Widodo yang saat itu beliau masih menjabat sebagai wali kota Solo.</p>
                        <h5 class="mt-2 mb-2"><strong>VISI</strong></h5>
                        <p>Menyiapakan Insan Perhotelan yang Unggul, Berbudaya, Religius, Mandiri dan Berwawasan luas ke depan.</p>
                        <h5 class="mt-2 mb-2"><strong>MISI</strong></h5>
                        <p>
                            <ol>
                                <li>Membentuk Sumber Daya Manusia yang Profesional di bidang Industri Perhotelan.</li>
                                <li>Menyelanggarakan pendidikan dan latihan untuk memenuhi standart kebutuhan IDUKA.</li>
                                <li>Mempersiapkan lulusan yang selesai tepat pada waktunya.</li>
                            </ol>
                        </p>
                ...
                <div class="card">
                    <div class="card-body">
                        <h6><i class="fas fa-info-circle"></i>&nbsp <strong>Informasi lebih lanjut : </strong><a href="https://smkn7surakarta.sch.id/program-keahlian/Perhotelan/" target="_blank">Perhotelan</a> </h6>
                    </div>
                </div>
            </div>
        </div>
