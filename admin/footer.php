...
<!-- Script Add Description Surat Rekomendasi -->
	<script>
		function autodescript_recommendation() {
  const dropdown = document.getElementById("jenis_rekomendasi");
  const deskripsi = document.getElementById("deskripsi");
  const penutup_surat = document.getElementById("penutup_surat");

  const selectedValue = dropdown.value;

  if (selectedValue === "Lomba") {
    deskripsi.value = "Siswa tersebut adalah benar-benar '[kelas]' SMK Negeri 7 Surakarta pada Tahun Ajaran '[tahun_ajaran]'. Menurut data kami, selama menjadi siswa, yang bersangkutan termasuk siswa berkelakuan baik, dan memiliki motivasi yang tinggi untuk belajar. Berikut ini prestasi akademik secara rinci yang telah dicapai :";
    penutup_surat.value = "Demikian surat rekomendasi ini dibuat untuk melengkapi persyaratan Lomba '[isi_lomba]'.";
} else if (selectedValue === "Beasiswa KIPK") {
	deskripsi.value = "Siswa tersebut adalah benar-benar '[kelas]' SMK Negeri 7 Surakarta pada Tahun Ajaran '[tahun_ajaran]'. Menurut data kami, selama menjadi siswa, yang bersangkutan termasuk siswa berkelakuan baik, dan memiliki motivasi yang tinggi untuk belajar. Berikut ini prestasi akademik secara rinci yang telah dicapai :";
	penutup_surat.value = "Demikian surat rekomendasi ini dibuat untuk melengkapi persyaratan pengajuan Beasiswa KIPK di Politeknik Indonusa.";
} else if (selectedValue === "Beasiswa Lainnya") {
	deskripsi.value = "Adalah Benar-benar '[kelas]' SMKN 7 Surakarta Pada Tahun Ajaran '[tahun_ajaran]'. Surat Rekomendasi ini dibuat untuk <b>Persyaratan Mendaftar Beasiswa di '[universitas]'</b>.";
	penutup_surat.value = "Demikian surat rekomendasi ini dibuat untuk melengkapi persyaratan pengajuan Beasiswa di '[universitas]'.";
} else if (selectedValue === "Bantuan"){
	deskripsi.value = "Surat Rekomendasi Bantuan";
	penutup_surat.value = "Demikian surat rekomendasi ini dibuat untuk melengkapi persyaratan pengajuan PKH.";
  } else {
    // Clear fields if no option or default is selected
    deskripsi_ranking.value = "";
  }
}
	</script>

	<!-- Script Add Description Surat Rekomendasi Ranking (KIPK)-->
	<script>
		function autodescript_rank() {
  const dropdown = document.getElementById("jenis_rekomendasi_ranking");
  const deskripsi_ranking = document.getElementById("deskripsi_ranking");
  const penutup_surat = document.getElementById("penutup_surat");

  const selectedValue = dropdown.value;

  if (selectedValue === "Lomba") {
    deskripsi_ranking.value = "Siswa tersebut adalah benar-benar '[kelas]' SMK Negeri 7 Surakarta pada Tahun Ajaran '[tahun_ajaran]' <br><br>Menurut data kami, selama menjadi siswa, yang bersangkutan termasuk siswa berkelakuan baik, dan memiliki motivasi yang tinggi untuk belajar. Berikut ini prestasi akademik secara rinci yang telah dicapai :";
    penutup_surat.value = "Demikian surat rekomendasi ini dibuat untuk melengkapi persyaratan Lomba '[isi_lomba]'.";
} else if (selectedValue === "Beasiswa KIPK") {
	deskripsi_ranking.value = "Siswa tersebut adalah benar-benar '[kelas]' SMK Negeri 7 Surakarta pada Tahun Ajaran '[tahun_ajaran]' <br><br>Menurut data kami, selama menjadi siswa, yang bersangkutan termasuk siswa berkelakuan baik, dan memiliki motivasi yang tinggi untuk belajar. Berikut ini prestasi akademik secara rinci yang telah dicapai :";
	penutup_surat.value = "Demikian surat rekomendasi ini dibuat untuk melengkapi persyaratan pengajuan Beasiswa KIPK di Politeknik Indonusa.";
} else if (selectedValue === "Beasiswa Lainnya") {
	deskripsi_ranking.value = "Adalah Benar-benar '[kelas]' SMKN 7 Surakarta Pada Tahun Ajaran '[tahun_ajaran]'. Surat Rekomendasi ini dibuat untuk <b>Persyaratan Mendaftar Beasiswa di '[universitas]'</b>.";
	penutup_surat.value = "Demikian surat rekomendasi ini dibuat untuk melengkapi persyaratan pengajuan Beasiswa di '[universitas]'.";
} else if (selectedValue === "Bantuan"){
	deskripsi_ranking.value = "Surat Rekomendasi Bantuan";
	penutup_surat.value = "Demikian surat rekomendasi ini dibuat untuk melengkapi persyaratan pengajuan PKH.";
  } else {
    // Clear fields if no option or default is selected
    deskripsi_ranking.value = "";
