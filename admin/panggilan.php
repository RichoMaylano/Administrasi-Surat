...
$title = "Surat Panggilan | Administrasi";
include '_header.php';
?>
...
<div class="row">
    ...
    <div class="card shadow mb-4" style="width:80%; left:10%">
	  ...
	  <div class="row">
		<div class="col-sm-10">
			<h4 class="m-0 font-weight-bold"><i class="fa-solid fa-phone-volume"></i>&nbsp <strong>Surat Panggilan Orang Tua</strong></h4>
		</div>
		<div class="col-sm-2">
				<div class="btn-group shadow rounded">
					<!-- Button trigger modal -->
					<a class="btn btn-light bg-gradient" type="button" data-bs-toggle="modal" data-bs-target="#add_panggilan"aria-current="page">Tambah Data</a>
					<a href="#" class="btn btn-secondary bg-gradient text-white active"><i class="fa-regular fa-square-plus"></i></a>
				</div>
		</div>
		</div>
...
<!-- Modal Tambah Data-->
<div class="modal fade" tabindex="-1" id="add_panggilan" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-success text-white">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-regular fa-square-plus"></i> &nbspTambah Data <strong>Surat Panggilan Orang Tua</strong></h5>
	  ...
	  <!-- Nomor Surat -->
        <h6 class="m-0 font-weight-bold mb-3">1. Nomor Surat</h6>
	     <div class="form-group row">
            ...
            <div id="emailHelp" class="form-text text-danger"><strong>Contoh : 421.3/1770 (Inputkan Nomor Surat 1770)</strong></div>
			</div>
        </div>
        ...
        <h6 class="m-0 font-weight-bold mb-3">2. Nama Lengkap</h6>
	     <div class="form-group row">
			<div class="form-group mb-3">
			<select id="nama_lengkap2" class="form-control" name="nama_lengkap">
    ...
    <div class="form-group row">
		<div class="col-sm-6">
			<div class="form-group mb-3">
					<input type="text" name="nama_ayah" class="form-control" id="nama_ayah3" placeholder="Masukkan Nama Ayah" readonly>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group mb-3">
						<input type="text" name="nama_ibu" class="form-control" id="nama_ibu3" placeholder="Masukkan Nama Ibu" readonly>
				</div>
            </div>
        </div>
        ...
        <!-- Nama Wali Kelas -->
	     ...
	     <div class="form-group row">
		 <div class="form-group mb-3">
		 <select id="nama_guru3" class="form-control" name="nama_walikelas">
		...
		<!-- NIP Wali Kelas -->
	     ...
	     <div class="form-group row">
		 <div class="form-group mb-3">
				<input type="text" name="nip_walikelas" class="form-control" id="nip_guru3" placeholder="Masukkan NIP Wali Kelas" readonly>    
        </div>
        </div>
    ...
    <div class="form-group row">
		<div class="col-sm-6">
			<div class="form-group mb-3">
					<input type="text" name="pangkat_walikelas" class="form-control" id="pangkat_guru3" placeholder="Masukkan Pangkat Wali Kelas" readonly>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group mb-3">
						<input type="text" name="golongan_walikelas" class="form-control" id="golongan_guru3" placeholder="Masukkan Golongan Wali Kelas" readonly>
				</div>
            </div>
        </div>
        ...
        <!-- Nama Guru BP/BK -->
	     ...
	     <div class="form-group row">
		 <div class="form-group mb-3">
		 <select id="nama_guru4" class="form-control" name="nama_bk">
		...
		<!-- Nama Guru BP/BK -->
	     ...
	     <div class="form-group row">
		 <div class="form-group mb-3">
				<input type="text" name="nip_bk" class="form-control" id="nip_guru4" placeholder="Masukkan NIP Guru BP/BK" readonly>    
        </div>
        </div>
    ...
    <div class="form-group row">
		<div class="col-sm-6">
			<div class="form-group mb-3">
					<input type="text" name="pangkat_bk" class="form-control" id="pangkat_guru4" placeholder="Masukkan Pangkat Guru BP/BK" readonly>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group mb-3">
						<input type="text" name="golongan_bk" class="form-control" id="golongan_guru4" placeholder="Masukkan Golongan Guru BP/BK" readonly>
				</div>
            </div>
        </div>
    ...
    <div class="form-group row">
     ...
     <h6 class="m-0 font-weight-bold mb-3">17. Tempat Pertemuan</h6>
	     <div class="form-group row">
		 <div class="form-group mb-3">
				<input type="text" name="tempat" class="form-control" id="tempat" placeholder="Masukkan Tempat Pertemuan" required autofocus>   
				<div id="emailHelp" class="form-text text-danger"><strong>Contoh : Edotel</strong></div>
        </div>
        </div>
			...
			if(mysqli_num_rows($qsiswa) > 0){
				while($data = mysqli_fetch_array($qsiswa)){
					...
					Aksi
					 ...
					 <li><a href="../cetak_panggilan.php?no_surat='.$data['no_surat'].'"><button class="btn btn-sm"><i class="fas fa-download"></i> Unduh</button></a> </li>
					 <li><a data-bs-toggle="modal" data-bs-target="#edit_panggilan'.htmlspecialchars($data['id_surat']).'" class="btn btn-sm"><i class="fas fa-edit"></i> Edit</button></a></li>
					 <li><a data-bs-toggle="modal" data-bs-target="#delete_panggilan'.htmlspecialchars($data['id_surat']).'"  class="btn btn-sm"><i class="fas fa-trash"></i> Hapus</a></li>
					 </ul>
					 </div></td>';
					...
					?>
	<!-- Modal Edit Data-->
<div class="modal fade" tabindex="-1" id="edit_panggilan<?php echo htmlspecialchars($data['id_surat']) ?>" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-warning text-white">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-pen-to-square"></i> &nbspEdit Surat Panggilan Orang Tua<strong>421.3/<?php echo $data['no_surat']?> - <?php echo $data['nama_lengkap']?></strong></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
	  <form action="edit_proses_panggilan.php" class="form-horizontal" method="post">
        ...
        <h6 class="m-0 font-weight-bold mb-3">1. Nomor Surat</h6>
	     <div class="form-group row">
            ...
            <div id="emailHelp" class="form-text text-danger"><strong>Contoh : 421.3/958 (Inputkan Nomor Surat 958)</strong></div>
			</div>
        </div>
        ...
        <h6 class="m-0 font-weight-bold mb-3">2. Nama Lengkap</h6>
	     <div class="form-group row">
			<div class="form-group mb-3">
			<select id="nama_lengkap3" class="form-control" name="nama_lengkap">
    ...
    <div class="form-group row">
		<div class="col-sm-6">
			<div class="form-group mb-3">
					<input type="text" name="nama_ayah" class="form-control" id="nama_ayah4" value="<?php echo $data['nama_ayah']?>" readonly>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group mb-3">
						<input type="text" name="nama_ibu" class="form-control" id="nama_ibu4" value="<?php echo $data['nama_ibu']?>" readonly>
				</div>
            </div>
        </div>
        ...
        <!-- Nama Wali Kelas -->
	     ...
	     <div class="form-group row">
		 <div class="form-group mb-3">
		 <select id="nama_guru5" class="form-control" name="nama_walikelas">
		...
		<!-- NIP Wali Kelas -->
	     ...
	     <div class="form-group row">
		 <div class="form-group mb-3">
				<input type="text" name="nip_walikelas" class="form-control" id="nip_guru5" value="<?php echo $data['nip_walikelas']?>" readonly>    
        </div>
        </div>
    ...
    <div class="form-group row">
		<div class="col-sm-6">
			<div class="form-group mb-3">
				<input type="text" name="pangkat_walikelas" class="form-control" id="pangkat_guru5" value="<?php echo $data['pangkat_walikelas']?>" readonly>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group mb-3">
					<input type="text" name="golongan_walikelas" class="form-control" id="golongan_guru5" value="<?php echo $data['golongan_walikelas']?>" readonly>
				</div>
            </div>
        </div>
        ...
        <!-- Nama Guru BP/BK -->
	     ...
	     <div class="form-group row">
		 <div class="form-group mb-3">
		 <select id="nama_guru6" class="form-control" name="nama_bk">
		...
		<!-- Nama Guru BP/BK -->
	     ...
	     <div class="form-group row">
		 <div class="form-group mb-3">
				<input type="text" name="nip_bk" class="form-control" id="nip_guru6" value="<?php echo $data['nip_bk']?>" readonly>    
        </div>
        </div>
    ...
    <div class="form-group row">
		<div class="col-sm-6">
			<div class="form-group mb-3">
					<input type="text" name="pangkat_bk" class="form-control" id="pangkat_guru6" value="<?php echo $data['pangkat_bk']?>" readonly>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group mb-3">
						<input type="text" name="golongan_bk" class="form-control" id="golongan_guru6" value="<?php echo $data['golongan_bk']?>" readonly>
				</div>
            </div>
        </div>
...
<!-- Modal Delete Data-->
<div class="modal fade" id="delete_panggilan<?php echo htmlspecialchars($data['id_surat']) ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-danger text-white">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-trash-can"></i> &nbspHapus Surat Panggilan Orang Tua <strong>094/<?php echo $data['no_surat']?> - <?php echo $data['nama_lengkap']?></strong></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
		<h4>Detail Surat</h4>
	...
	<h5>Yakin ingin menghapus Surat Panggilan Orang Tua <strong>Nomor 421.3/<?php echo $data['no_surat']?></strong> ?</h5>
	<div class="modal-footer">
		<button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="fas fa-times"></i> Batal</button>
        <a href="delete_proses_panggilan.php?id_surat=<?php echo $data['id_surat']?>" type="submit" name="submit" class="btn btn-success"><i class="fas fa-check"></i> Yakin</a>
	</div>
    </div>
  </div>
</div>
...
<script>
		$(function() {
			$("#nama_lengkap2").change(function(){
				var nama_lengkap = $("#nama_lengkap2").val();
				...
				$.ajax({
					...
					success: function (data_siswa) {
						...
						$("#nama_ayah3").val(data_siswa['nama_ibu']);
						} else{
							$("#nama_ayah3").val(data_siswa['nama_ayah']);
						}
						$("#nama_ibu3").val(data_siswa['nama_ibu']);
...
<script>
		$(function() {
			$("#nama_lengkap3").change(function(){
				var nama_lengkap = $("#nama_lengkap3").val();
				...
				$.ajax({
					...
					success: function (data_siswa) {
						if(data_siswa['nama_ayah'] == '-'){
						$("#nama_ayah4").val(data_siswa['nama_ibu']);
						} else{
							$("#nama_ayah4").val(data_siswa['nama_ayah']);
						}
						$("#nama_ibu4").val(data_siswa['nama_ibu']);
...
<script>
		$(function() {
			$("#nama_guru3").change(function(){
				var nama_guru = $("#nama_guru3").val();
				...
				$.ajax({
					...
					success: function (data_guru) {
						...
						$("#nip_guru3").val('-');
							...
							$("#nip_guru3").val(data_guru['nip_guru']);
						}
						$("#pangkat_guru3").val(data_guru['pangkat_guru']);
						$("#golongan_guru3").val(data_guru['golongan_guru']);
					}
				});
			});
		});
...
<script>
		$(function() {
			$("#nama_guru4").change(function(){
				var nama_guru = $("#nama_guru4").val();
				...
				$.ajax({
					...
					success: function (data_guru) {
						...
						$("#nip_guru4").val('-');
							...
							$("#nip_guru4").val(data_guru['nip_guru']);
						}
						$("#pangkat_guru4").val(data_guru['pangkat_guru']);
						$("#golongan_guru4").val(data_guru['golongan_guru']);
					}
				});
			});
		});
...
<script>
		$(function() {
			$("#nama_guru5").change(function(){
				var nama_guru = $("#nama_guru5").val();
				...
				$.ajax({
					...
					success: function (data_guru) {
						...
						$("#nip_guru5").val('-');
							...
							$("#nip_guru5").val(data_guru['nip_guru']);
						}
						$("#pangkat_guru5").val(data_guru['pangkat_guru']);
						$("#golongan_guru5").val(data_guru['golongan_guru']);
					}
				});
			});
		});
...
<script>
		$(function() {
			$("#nama_guru6").change(function(){
				var nama_guru = $("#nama_guru6").val();
				...
				$.ajax({
					...
					success: function (data_guru) {
						...
						$("#nip_guru6").val('-');
							...
							$("#nip_guru6").val(data_guru['nip_guru']);
						}
						$("#pangkat_guru6").val(data_guru['pangkat_guru']);
						$("#golongan_guru6").val(data_guru['golongan_guru']);
					}
				});
			});
		});
