...
?>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <?php if(date("H:i:s") >= '06:00:00' && date("H:i:s") <= '10:00:00'){?>
        <a href="profile.php" class="btn btn-primary"><i class="fas fa-sun"></i> &nbsp Selamat Pagi, <?php echo $_SESSION['nama_lengkap']?></a> 
        <?php } else if(date("H:i:s") >= '10:00:01' && date("H:i:s") <= '14:00:00'){?>
        <a href="profile.php" class="btn btn-primary"><i class="fas fa-sun"></i> &nbsp Selamat Siang, <?php echo $_SESSION['nama_lengkap']?></a>
        <?php } else if(date("H:i:s") >= '14:00:01' && date("H:i:s") <= '15:30:00'){?>
        <a href="profile.php" class="btn btn-primary"><i class="fas fa-sun"></i> &nbsp Selamat Sore, <?php echo $_SESSION['nama_lengkap']?></a>  
        <?php } else if(date("H:i:s") >= '15:30:01'){?>
        <a href="profile.php" class="btn btn-primary"><i class="fas fa-running"></i> &nbsp Waktunya Pulang</a> 
      <?php } else { 
        echo '' ;
        }?>
    </li>
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <?php if($_SESSION['nama_lengkap'] == "Richo Maylano Yozienanda"){?>
            <img src="../assets/images/img_avatar.png" width="30px" alt="" class="img-circle">
            <?php } else {?>
              <i class="fas fa-user mr-2"></i>
              <?php }?>
          &nbsp&nbsp&nbsp<?php echo $_SESSION['nama_lengkap']?>
          </a>
          <div class="dropdown-divider"></div>
          ...
          <i class="fas fa-clock mr-2"></i>&nbsp&nbspWaktu Login
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
            <a href="index.php" class="nav-link <?php if($title == "Home Page | Aplikasi Persuratan | Versi 2.1.2" || $title == "Riwayat Pembaharuan Page | Aplikasi Persuratan | Versi 2.1.2"){ echo "active";}?>">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="jurusan/pekerjaan_sosial.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pekerjaan Sosial</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="jurusan/desain_komunikasi_visual.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Desain Komunikasi Visual</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="jurusan/perhotelan.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Perhotelan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="jurusan/kuliner.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kuliner</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="jurusan/pariwisata.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Usaha Layanan Pariwisata</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="jurusan/broadcasting.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
